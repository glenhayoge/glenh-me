    ...
    <footer className="border-t border-gray-200 dark:border-gray-800 mt-16">
      <div className="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        {/* <div className="flex items-center mb-8">
          ...
          <span className="px-4 text-sm text-gray-500 dark:text-gray-400">You've reached the bottom 👋</span>
          <hr className="flex-grow border-gray-200 dark:border-gray-800"/>
        </div> */}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/" className="hover:opacity-80 transition-opacity">
              ...
              <svg
                className="w-12 h-12 border-2 bg-gray-400 dark:bg-yellow-400 border-gray-500 rounded-full dark:border-yellow-400 hover:bg-gray-900 dark:hover:bg-yellow-300 transition-colors"
                fill="currentColor"
            ...
            <div>
              {/* <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Glensea.com</p> */}
              <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
            &copy; {new Date().getFullYear()} Glensea.com - Contents from 2018 / <Link 
            href="https://github.com/glenhayoge/glenh-me" 
            target="_blank"
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 text-xs text-gray-500 dark:text-gray-400 py-6 dark:border-gray-800">
        ...
        {/* Tech Stack */}
        {/* <div className="flex flex-wrap items-center justify-center gap-3 text-xs text-gray-500 dark:text-gray-400 mb-6 py-4 border-t border-gray-200 dark:border-gray-800">
          <span>Crafted by GlenH with 🔥 using</span>
          <span className="inline-flex items-center gap-1">
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
        ...
        {/* Bottom Bar */}
        {/* <div className="flex flex-col sm:flex-row text-center items-left justify-left gap-4  dark:border-gray-800">
          <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
            &copy; {new Date().getFullYear()} Glensea.com - Contents from 2018
          </p>
          <Link 
            href="https://github.com/glenhayoge/glenh-me" 
            target="_blank"
