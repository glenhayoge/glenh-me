                  ...
                  <div className="px-4 text-center">
                    <div className="flex justify-center space-x-4 my-6">
                      <Link
                        ...
                        className="text-xl xl:grid place-item-center p-2 w-8 h-8 text-gray-500 rounded-full cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-800 relative"
                      >
                      ...
                      >
                        ...
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="currentColor"
                          className="bi bi-linkedin w-4 h-4"
                          viewBox="0 0 16 16"
                        >
                      ...
                      <Link
                        ...
                        className="text-xl  p-2 xl:grid place-item-center w-8 h-8 text-gray-500 rounded-full  cursor-pointer dark:hover:bg-gray-800 hover:bg-gray-300 relative"
                      >
                        <span className="sr-only">StackOverFlow</span>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="currentColor"
                          className="bi bi-stack-overflow w-4 h-4"
                          viewBox="0 0 16 16"
                        >
                      ...
                      <Link
                        href="#"
                        className="text-xl p-2 xl:grid place-item-center w-8 h-8 text-gray-500 rounded-full cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-800 relative"
                      >
                      ...
                      <Link
                        href="#"
                        className="text-xl p-2 xl:grid place-item-center rounded-full w-8 h-8 text-gray-500 cursor-pointer dark:hover:bg-gray-800 hover:bg-gray-300 relative"
                      >
