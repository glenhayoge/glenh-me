  ...
  return (
    ...
    <div class="grid px-2 w-full md:px-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
        <div className=" z-20 place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl lg:pl-5 font-extrabold tracking-tight text-gray-600 leading-none md:text-5xl xl:text-6xl dark:text-white"><span class="text-yellow-400">d</span>eveloper &#x2022; <span class="text-yellow-400">d</span>esigner &#x2022; <span class="text-yellow-400">c</span>reator</h1>
