...
const Header = () => {
  return (
    ...
    <div class="grid max-w-5xl px-2 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex flex-col items-center">
            ...
            <h5 style={signature} className="mt-4 text-gray-600 dark:text-yellow-400 text-center text-xl mb-4">
              GlenGHayoge
            </h5>
        </div>                
    </div>
